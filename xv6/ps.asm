...
main(int argc, char *argv[])
{
  ...
  23:	8d b5 e4 f9 ff ff    	lea    -0x61c(%ebp),%esi
  29:	56                   	push   %esi
  2a:	e8 54 04 00 00       	call   483 <getprocinfo>
    if(argc==1)
  2f:	83 c4 10             	add    $0x10,%esp
  32:	83 fb 01             	cmp    $0x1,%ebx
  35:	74 32                	je     69 <main+0x69>
  ...
  3a:	0f 84 a9 00 00 00    	je     e9 <main+0xe9>
      }
  ...
  40:	50                   	push   %eax
  41:	50                   	push   %eax
  42:	68 b4 08 00 00       	push   $0x8b4
  47:	6a 02                	push   $0x2
  49:	e8 02 05 00 00       	call   550 <printf>
  4e:	83 c4 10             	add    $0x10,%esp
    }
  }

  exit();
  51:	e8 8d 03 00 00       	call   3e3 <exit>
    printf(1, "No arguments!\n");
  56:	50                   	push   %eax
  57:	50                   	push   %eax
  58:	68 78 08 00 00       	push   $0x878
  5d:	6a 01                	push   $0x1
  5f:	e8 ec 04 00 00       	call   550 <printf>
  64:	83 c4 10             	add    $0x10,%esp
  67:	eb e8                	jmp    51 <main+0x51>
      printf(1,"PID\t|\tName\t|\tSize\n");
  69:	50                   	push   %eax
  6a:	50                   	push   %eax
  6b:	68 87 08 00 00       	push   $0x887
  70:	6a 01                	push   $0x1
  ...
  7a:	83 c4 10             	add    $0x10,%esp
      len = ps.length;
  7d:	89 85 bc f9 ff ff    	mov    %eax,-0x644(%ebp)
      for(i=0;i<len;i++)
  83:	85 c0                	test   %eax,%eax
  85:	7e ca                	jle    51 <main+0x51>
  87:	8d 95 e4 fa ff ff    	lea    -0x51c(%ebp),%edx
  8d:	31 db                	xor    %ebx,%ebx
  8f:	8d bd d4 f9 ff ff    	lea    -0x62c(%ebp),%edi
  95:	8d 76 00             	lea    0x0(%esi),%esi
        strcpy(name,ps.name[i]);
  98:	83 ec 08             	sub    $0x8,%esp
        pid = ps.pid[i];
  9b:	8b 0c 9e             	mov    (%esi,%ebx,4),%ecx
        strcpy(name,ps.name[i]);
  9e:	89 95 c4 f9 ff ff    	mov    %edx,-0x63c(%ebp)
  a4:	52                   	push   %edx
  a5:	57                   	push   %edi
        pid = ps.pid[i];
  a6:	89 8d c0 f9 ff ff    	mov    %ecx,-0x640(%ebp)
        strcpy(name,ps.name[i]);
  ac:	e8 df 00 00 00       	call   190 <strcpy>
        printf(1,"%d\t|\t%s\t|\t%d\n",pid,name,sz);
  b1:	8b 8d c0 f9 ff ff    	mov    -0x640(%ebp),%ecx
  b7:	58                   	pop    %eax
  b8:	ff b4 9e 00 05 00 00 	push   0x500(%esi,%ebx,4)
  bf:	57                   	push   %edi
      for(i=0;i<len;i++)
  c0:	83 c3 01             	add    $0x1,%ebx
        printf(1,"%d\t|\t%s\t|\t%d\n",pid,name,sz);
  c3:	51                   	push   %ecx
  c4:	68 9a 08 00 00       	push   $0x89a
  c9:	6a 01                	push   $0x1
  cb:	e8 80 04 00 00       	call   550 <printf>
      for(i=0;i<len;i++)
  d0:	8b 95 c4 f9 ff ff    	mov    -0x63c(%ebp),%edx
  d6:	83 c4 20             	add    $0x20,%esp
  d9:	83 c2 10             	add    $0x10,%edx
  dc:	39 9d bc f9 ff ff    	cmp    %ebx,-0x644(%ebp)
  e2:	75 b4                	jne    98 <main+0x98>
  e4:	e9 68 ff ff ff       	jmp    51 <main+0x51>
      pid = atoi(argv[1]);
  e9:	83 ec 0c             	sub    $0xc,%esp
  ec:	ff 77 04             	push   0x4(%edi)
  ef:	e8 7c 02 00 00       	call   370 <atoi>
      if(pid<1 || pid>NPROC)
  f4:	83 c4 10             	add    $0x10,%esp
      pid = atoi(argv[1]);
  f7:	89 c7                	mov    %eax,%edi
      if(pid<1 || pid>NPROC)
  f9:	8d 40 ff             	lea    -0x1(%eax),%eax
  fc:	83 f8 3f             	cmp    $0x3f,%eax
  ff:	77 74                	ja     175 <main+0x175>
      for(i=0; i<ps.length;i++)
 101:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 104:	31 db                	xor    %ebx,%ebx
 106:	85 c0                	test   %eax,%eax
 108:	7f 0d                	jg     117 <main+0x117>
 10a:	eb 53                	jmp    15f <main+0x15f>
 10c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 110:	83 c3 01             	add    $0x1,%ebx
 113:	39 c3                	cmp    %eax,%ebx
 115:	74 48                	je     15f <main+0x15f>
        if(ps.pid[i] == pid)
 117:	39 3c 9e             	cmp    %edi,(%esi,%ebx,4)
 11a:	75 f4                	jne    110 <main+0x110>
          printf(1,"PID\t|\tName\t|\tSize\n");
 11c:	51                   	push   %ecx
 11d:	51                   	push   %ecx
 11e:	68 87 08 00 00       	push   $0x887
 123:	6a 01                	push   $0x1
 125:	e8 26 04 00 00       	call   550 <printf>
          strcpy(name,ps.name[i]);
 12a:	58                   	pop    %eax
 12b:	8d 43 10             	lea    0x10(%ebx),%eax
 12e:	5a                   	pop    %edx
 12f:	c1 e0 04             	shl    $0x4,%eax
 132:	01 c6                	add    %eax,%esi
 134:	56                   	push   %esi
 135:	8d b5 d4 f9 ff ff    	lea    -0x62c(%ebp),%esi
 13b:	56                   	push   %esi
 13c:	e8 4f 00 00 00       	call   190 <strcpy>
          printf(1,"%d\t|\t%s\t|\t%d\n",pid,name,sz);
 141:	59                   	pop    %ecx
 142:	ff b4 9d e4 fe ff ff 	push   -0x11c(%ebp,%ebx,4)
 149:	56                   	push   %esi
 14a:	57                   	push   %edi
 14b:	68 9a 08 00 00       	push   $0x89a
 150:	6a 01                	push   $0x1
 152:	e8 f9 03 00 00       	call   550 <printf>
          exit();
 157:	83 c4 20             	add    $0x20,%esp
 15a:	e8 84 02 00 00       	call   3e3 <exit>
      printf(2,"Error: No Process for this PID\n");
 15f:	52                   	push   %edx
 160:	52                   	push   %edx
 161:	68 d0 08 00 00       	push   $0x8d0
 166:	6a 02                	push   $0x2
 168:	e8 e3 03 00 00       	call   550 <printf>
 16d:	83 c4 10             	add    $0x10,%esp
 170:	e9 dc fe ff ff       	jmp    51 <main+0x51>
        printf(2,"Error: PID\n");
 175:	53                   	push   %ebx
 176:	53                   	push   %ebx
 177:	68 a8 08 00 00       	push   $0x8a8
 17c:	6a 02                	push   $0x2
 17e:	e8 cd 03 00 00       	call   550 <printf>
        exit();
 183:	e8 5b 02 00 00       	call   3e3 <exit>
