...
80100ba3:	e8 78 64 00 00       	call   80107020 <allocuvm>
...
80100bd9:	e8 52 63 00 00       	call   80106f30 <loaduvm>
...
80100c1b:	e8 60 65 00 00       	call   80107180 <freevm>
  if(ip){
...
80100c62:	e8 b9 63 00 00       	call   80107020 <allocuvm>
...
80100d11:	e8 6a 64 00 00       	call   80107180 <freevm>
...
80100dcd:	e8 ce 5f 00 00       	call   80106da0 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 a6 63 00 00       	call   80107180 <freevm>
  return 0;
...
80103022:	e8 79 2c 00 00       	call   80105ca0 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 45 3d 00 00       	call   80106d90 <switchkvm>
  seginit();
8010304b:	e8 b0 3c 00 00       	call   80106d00 <seginit>
  lapicinit();
...
80103090:	e8 6b 3c 00 00       	call   80106d00 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 e7 2e 00 00       	call   80105f90 <uartinit>
  pinit();         // process table
801030a9:	e8 22 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 6d 2b 00 00       	call   80105c20 <tvinit>
  binit();         // buffer cache
...
801037fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103802:	e8 99 10 00 00       	call   801048a0 <release>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 07 5c 10 80 	movl   $0x80105c07,0x14(%eax)
  p->context = (struct context*)sp;
...
80103836:	e8 85 11 00 00       	call   801049c0 <memset>
...
8010385a:	e8 41 10 00 00       	call   801048a0 <release>
}
...
8010388b:	e8 10 10 00 00       	call   801048a0 <release>
...
801038d6:	68 a0 7a 10 80       	push   $0x80107aa0
801038db:	68 20 1d 11 80       	push   $0x80111d20
801038e0:	e8 4b 0e 00 00       	call   80104730 <initlock>
}
...
80103974:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103977:	e8 34 0e 00 00       	call   801047b0 <pushcli>
  c = mycpu();
8010397c:	e8 6f ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103981:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103987:	e8 74 0e 00 00       	call   80104800 <popcli>
}
...
801039b3:	e8 48 38 00 00       	call   80107200 <setupkvm>
...
801039d1:	e8 da 34 00 00       	call   80106eb0 <inituvm>
...
801039e6:	e8 d5 0f 00 00       	call   801049c0 <memset>
...
80103a3f:	68 d0 7a 10 80       	push   $0x80107ad0
80103a44:	50                   	push   %eax
80103a45:	e8 36 11 00 00       	call   80104b80 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 d9 7a 10 80 	movl   $0x80107ad9,(%esp)
...
80103a83:	68 b7 7a 10 80       	push   $0x80107ab7
...
80103a95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a98:	e8 13 0d 00 00       	call   801047b0 <pushcli>
  c = mycpu();
80103a9d:	e8 4e fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103aa2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa8:	e8 53 0d 00 00       	call   80104800 <popcli>
  sz = curproc->sz;
...
80103abb:	e8 e0 32 00 00       	call   80106da0 <switchuvm>
  return 0;
...
80103ada:	e8 41 35 00 00       	call   80107020 <allocuvm>
...
80103afa:	e8 51 36 00 00       	call   80107150 <deallocuvm>
...
80103b16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b19:	e8 92 0c 00 00       	call   801047b0 <pushcli>
  c = mycpu();
80103b1e:	e8 cd fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b29:	e8 d2 0c 00 00       	call   80104800 <popcli>
  if((np = allocproc()) == 0){
...
80103b48:	e8 a3 37 00 00       	call   801072f0 <copyuvm>
...
80103c5e:	e8 9d 0c 00 00       	call   80104900 <acquire>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 44 0f 00 00       	call   80104bdb <swtch>
      switchkvm();
80103c97:	e8 f4 30 00 00       	call   80106d90 <switchkvm>
      c->proc = 0;
...
80103d33:	e8 a3 0e 00 00       	call   80104bdb <swtch>
  mycpu()->intena = intena;
...
80103dfa:	e8 01 0b 00 00       	call   80104900 <acquire>
...
80103e9d:	68 28 7b 10 80       	push   $0x80107b28
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 1b 7b 10 80       	push   $0x80107b1b
...
80103f2b:	0f 85 95 00 00 00    	jne    80103fc6 <wait+0x106>
  pushcli();
80103f31:	e8 7a 08 00 00       	call   801047b0 <pushcli>
  c = mycpu();
80103f36:	e8 b5 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f3b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f41:	e8 ba 08 00 00       	call   80104800 <popcli>
  if(p == 0)
...
80103f89:	e8 f2 31 00 00       	call   80107180 <freevm>
        p->pid = 0;
...
80103fb5:	e8 e6 08 00 00       	call   801048a0 <release>
        return pid;
...
80103ffc:	e8 ff 08 00 00       	call   80104900 <acquire>
  pushcli();
80104001:	e8 aa 07 00 00       	call   801047b0 <pushcli>
  c = mycpu();
80104006:	e8 e5 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010400b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104011:	e8 ea 07 00 00       	call   80104800 <popcli>
...
80104029:	e8 72 08 00 00       	call   801048a0 <release>
}
...
8010404c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010404f:	e8 5c 07 00 00       	call   801047b0 <pushcli>
  c = mycpu();
80104054:	e8 97 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104059:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010405f:	e8 9c 07 00 00       	call   80104800 <popcli>
  if(p == 0)
...
80104080:	e8 7b 08 00 00       	call   80104900 <acquire>
    release(lk);
80104085:	89 34 24             	mov    %esi,(%esp)
80104088:	e8 13 08 00 00       	call   801048a0 <release>
  p->chan = chan;
...
801040aa:	e8 f1 07 00 00       	call   801048a0 <release>
    acquire(lk);
...
801040bb:	5d                   	pop    %ebp
    acquire(lk);
801040bc:	e9 3f 08 00 00       	jmp    80104900 <acquire>
...
801040e9:	68 3a 7b 10 80       	push   $0x80107b3a
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 34 7b 10 80       	push   $0x80107b34
...
8010410f:	e8 ec 07 00 00       	call   80104900 <acquire>
...
80104150:	c9                   	leave  
  release(&ptable.lock);
80104151:	e9 4a 07 00 00       	jmp    801048a0 <release>
...
8010416f:	e8 8c 07 00 00       	call   80104900 <acquire>
...
801041ab:	e8 f0 06 00 00       	call   801048a0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041c8:	e8 d3 06 00 00       	call   801048a0 <release>
}
...
801041e6:	bb c0 1d 11 80       	mov    $0x80111dc0,%ebx
...
801041f3:	e8 08 07 00 00       	call   80104900 <acquire>
  for(i=0,j=0,p = ptable.proc; p < &ptable.proc[NPROC]; p++,i++){//p++ -> p(struct proc OLD) + sizeof(struct proc) -> p (struct proc NEW)
801041f8:	8b 75 08             	mov    0x8(%ebp),%esi
801041fb:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80104202:	83 c4 10             	add    $0x10,%esp
80104205:	8d be 00 01 00 00    	lea    0x100(%esi),%edi
8010420b:	eb 14                	jmp    80104221 <getprocinfo+0x41>
8010420d:	8d 76 00             	lea    0x0(%esi),%esi
80104210:	83 c3 7c             	add    $0x7c,%ebx
80104213:	83 c6 04             	add    $0x4,%esi
80104216:	83 c7 10             	add    $0x10,%edi
80104219:	81 fb c0 3c 11 80    	cmp    $0x80113cc0,%ebx
8010421f:	74 2f                	je     80104250 <getprocinfo+0x70>
    if(p->state != UNUSED)
80104221:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104224:	85 c0                	test   %eax,%eax
80104226:	74 e8                	je     80104210 <getprocinfo+0x30>
    {
      ps->pid[i] = p->pid;
...
8010422b:	83 ec 04             	sub    $0x4,%esp
      ps->pid[i] = p->pid;
8010422e:	89 06                	mov    %eax,(%esi)
      safestrcpy(ps->name[i], p->name, sizeof(p->name));
80104230:	6a 10                	push   $0x10
80104232:	53                   	push   %ebx
80104233:	57                   	push   %edi
80104234:	e8 47 09 00 00       	call   80104b80 <safestrcpy>
      ps->sz[i] = p->sz;
80104239:	8b 43 94             	mov    -0x6c(%ebx),%eax
      j++;
8010423c:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
80104240:	83 c4 10             	add    $0x10,%esp
      ps->sz[i] = p->sz;
80104243:	89 86 00 05 00 00    	mov    %eax,0x500(%esi)
      j++;
80104249:	eb c5                	jmp    80104210 <getprocinfo+0x30>
...
80104253:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  release(&ptable.lock);
80104256:	83 ec 0c             	sub    $0xc,%esp
  ps->length = j;
80104259:	89 90 00 06 00 00    	mov    %edx,0x600(%eax)
  release(&ptable.lock);
8010425f:	68 20 1d 11 80       	push   $0x80111d20
80104264:	e8 37 06 00 00       	call   801048a0 <release>
  return 0;
}
...
80104289:	8b 7d 10             	mov    0x10(%ebp),%edi
        v[index]=vec[i];
8010428c:	6b 45 10 7c          	imul   $0x7c,0x10(%ebp),%eax
80104290:	03 45 0c             	add    0xc(%ebp),%eax
walk(struct proc *vec,struct proc *v,int index,int pid){
80104293:	8b 55 14             	mov    0x14(%ebp),%edx
        walk(vec,v,index+1,vec[i].pid);
80104296:	83 c7 01             	add    $0x1,%edi
        v[index]=vec[i];
80104299:	89 45 e4             	mov    %eax,-0x1c(%ebp)
8010429c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  for(i=0,flag=0;i<NPROC;i++)
8010429f:	31 c0                	xor    %eax,%eax
        walk(vec,v,index+1,vec[i].pid);
801042a1:	89 7d e0             	mov    %edi,-0x20(%ebp)
801042a4:	eb 16                	jmp    801042bc <walk+0x3c>
801042a6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801042ad:	8d 76 00             	lea    0x0(%esi),%esi
  for(i=0,flag=0;i<NPROC;i++)
801042b0:	83 f8 40             	cmp    $0x40,%eax
801042b3:	0f 84 07 01 00 00    	je     801043c0 <walk+0x140>
801042b9:	83 c3 7c             	add    $0x7c,%ebx
    if(vec[i].state!=UNUSED)
801042bc:	8b 4b 0c             	mov    0xc(%ebx),%ecx
        if(vec[i+1].state!=UNUSED){
          for(j=i+1;j<NPROC;j++)
801042bf:	83 c0 01             	add    $0x1,%eax
    if(vec[i].state!=UNUSED)
801042c2:	85 c9                	test   %ecx,%ecx
801042c4:	74 ea                	je     801042b0 <walk+0x30>
      if(vec[i].parent->pid == pid)
801042c6:	8b 4b 14             	mov    0x14(%ebx),%ecx
801042c9:	39 51 10             	cmp    %edx,0x10(%ecx)
801042cc:	75 e2                	jne    801042b0 <walk+0x30>
        v[index]=vec[i];
801042ce:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801042d1:	b9 1f 00 00 00       	mov    $0x1f,%ecx
801042d6:	89 de                	mov    %ebx,%esi
        cprintf("->\t[PID: %d Name: %s]\t",vec[i].pid,vec[i].name);
801042d8:	83 ec 04             	sub    $0x4,%esp
        v[index]=vec[i];
801042db:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
        cprintf("->\t[PID: %d Name: %s]\t",vec[i].pid,vec[i].name);
801042dd:	8d 4b 6c             	lea    0x6c(%ebx),%ecx
801042e0:	89 55 14             	mov    %edx,0x14(%ebp)
801042e3:	51                   	push   %ecx
801042e4:	ff 73 10             	push   0x10(%ebx)
801042e7:	68 4b 7b 10 80       	push   $0x80107b4b
801042ec:	89 45 dc             	mov    %eax,-0x24(%ebp)
801042ef:	e8 ac c3 ff ff       	call   801006a0 <cprintf>
        walk(vec,v,index+1,vec[i].pid);
801042f4:	ff 73 10             	push   0x10(%ebx)
801042f7:	ff 75 e0             	push   -0x20(%ebp)
801042fa:	ff 75 0c             	push   0xc(%ebp)
801042fd:	ff 75 08             	push   0x8(%ebp)
80104300:	e8 7b ff ff ff       	call   80104280 <walk>
        if(vec[i+1].state!=UNUSED){
80104305:	8b 93 88 00 00 00    	mov    0x88(%ebx),%edx
8010430b:	83 c4 20             	add    $0x20,%esp
8010430e:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104311:	85 d2                	test   %edx,%edx
80104313:	8b 55 14             	mov    0x14(%ebp),%edx
80104316:	74 98                	je     801042b0 <walk+0x30>
          for(j=i+1;j<NPROC;j++)
80104318:	83 f8 40             	cmp    $0x40,%eax
8010431b:	0f 84 9f 00 00 00    	je     801043c0 <walk+0x140>
80104321:	89 d9                	mov    %ebx,%ecx
80104323:	89 c6                	mov    %eax,%esi
80104325:	eb 18                	jmp    8010433f <walk+0xbf>
80104327:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010432e:	66 90                	xchg   %ax,%ax
80104330:	83 c6 01             	add    $0x1,%esi
80104333:	83 c1 7c             	add    $0x7c,%ecx
80104336:	83 fe 40             	cmp    $0x40,%esi
80104339:	0f 84 7a ff ff ff    	je     801042b9 <walk+0x39>
          {
            if(vec[j].parent->pid == pid)
8010433f:	8b b9 90 00 00 00    	mov    0x90(%ecx),%edi
80104345:	39 57 10             	cmp    %edx,0x10(%edi)
80104348:	75 e6                	jne    80104330 <walk+0xb0>
              break;
            }
          }
          if(flag==1)
...
8010434d:	89 45 dc             	mov    %eax,-0x24(%ebp)
            for(j=0;j<index;j++)
80104350:	31 ff                	xor    %edi,%edi
            cprintf("\n[PID: 1 Name: init]\t");
80104352:	68 62 7b 10 80       	push   $0x80107b62
80104357:	89 55 14             	mov    %edx,0x14(%ebp)
8010435a:	e8 41 c3 ff ff       	call   801006a0 <cprintf>
            for(j=0;j<index;j++)
8010435f:	8b 45 0c             	mov    0xc(%ebp),%eax
80104362:	83 c4 10             	add    $0x10,%esp
80104365:	8b 55 14             	mov    0x14(%ebp),%edx
80104368:	8d 70 6c             	lea    0x6c(%eax),%esi
8010436b:	8b 45 10             	mov    0x10(%ebp),%eax
8010436e:	85 c0                	test   %eax,%eax
80104370:	8b 45 dc             	mov    -0x24(%ebp),%eax
80104373:	0f 8e 40 ff ff ff    	jle    801042b9 <walk+0x39>
80104379:	89 45 d8             	mov    %eax,-0x28(%ebp)
8010437c:	89 55 14             	mov    %edx,0x14(%ebp)
8010437f:	89 5d dc             	mov    %ebx,-0x24(%ebp)
80104382:	89 f3                	mov    %esi,%ebx
...
80104390:	83 ec 04             	sub    $0x4,%esp
            for(j=0;j<index;j++)
80104393:	83 c7 01             	add    $0x1,%edi
              cprintf("->\t[PID: %d Name: %s]\t",v[j].pid,v[j].name);
80104396:	53                   	push   %ebx
            for(j=0;j<index;j++)
80104397:	83 c3 7c             	add    $0x7c,%ebx
              cprintf("->\t[PID: %d Name: %s]\t",v[j].pid,v[j].name);
8010439a:	ff b3 28 ff ff ff    	push   -0xd8(%ebx)
801043a0:	68 4b 7b 10 80       	push   $0x80107b4b
801043a5:	e8 f6 c2 ff ff       	call   801006a0 <cprintf>
            for(j=0;j<index;j++)
801043aa:	83 c4 10             	add    $0x10,%esp
801043ad:	39 fe                	cmp    %edi,%esi
801043af:	75 df                	jne    80104390 <walk+0x110>
801043b1:	8b 5d dc             	mov    -0x24(%ebp),%ebx
801043b4:	8b 45 d8             	mov    -0x28(%ebp),%eax
801043b7:	8b 55 14             	mov    0x14(%ebp),%edx
801043ba:	e9 fa fe ff ff       	jmp    801042b9 <walk+0x39>
801043bf:	90                   	nop
        }
      }
    }
...
801043d6:	83 ec 1c             	sub    $0x1c,%esp
  for(i=0,flag=0;i<NPROC;i++)
  {
    ...
    {
      v[index]=i;
801043d9:	8b 55 10             	mov    0x10(%ebp),%edx
801043dc:	8b 45 0c             	mov    0xc(%ebp),%eax
walk_prova(int *vec,int *v,int index,int pid){
801043df:	8b 7d 08             	mov    0x8(%ebp),%edi
801043e2:	8b 75 14             	mov    0x14(%ebp),%esi
      v[index]=i;
801043e5:	8d 04 90             	lea    (%eax,%edx,4),%eax
      cprintf("->\t[PID: %d]\t",i);
      walk_prova(vec,v,index+1,i);
801043e8:	8d 4a 01             	lea    0x1(%edx),%ecx
      v[index]=i;
801043eb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(i=0,flag=0;i<NPROC;i++)
801043ee:	31 c0                	xor    %eax,%eax
      walk_prova(vec,v,index+1,i);
801043f0:	89 4d e0             	mov    %ecx,-0x20(%ebp)
      if(vec[i+1]!=-1){
        for(j=i+1;j<NPROC;j++)
801043f3:	8d 58 01             	lea    0x1(%eax),%ebx
    if(vec[i] == pid)
801043f6:	39 34 87             	cmp    %esi,(%edi,%eax,4)
801043f9:	74 18                	je     80104413 <walk_prova+0x43>
801043fb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801043ff:	90                   	nop
  for(i=0,flag=0;i<NPROC;i++)
80104400:	83 fb 40             	cmp    $0x40,%ebx
80104403:	0f 84 b7 00 00 00    	je     801044c0 <walk_prova+0xf0>
        for(j=i+1;j<NPROC;j++)
80104409:	89 d8                	mov    %ebx,%eax
8010440b:	8d 58 01             	lea    0x1(%eax),%ebx
    if(vec[i] == pid)
8010440e:	39 34 87             	cmp    %esi,(%edi,%eax,4)
80104411:	75 ed                	jne    80104400 <walk_prova+0x30>
      v[index]=i;
80104413:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
      cprintf("->\t[PID: %d]\t",i);
80104416:	83 ec 08             	sub    $0x8,%esp
80104419:	89 45 dc             	mov    %eax,-0x24(%ebp)
      v[index]=i;
8010441c:	89 01                	mov    %eax,(%ecx)
      cprintf("->\t[PID: %d]\t",i);
8010441e:	50                   	push   %eax
8010441f:	68 78 7b 10 80       	push   $0x80107b78
80104424:	e8 77 c2 ff ff       	call   801006a0 <cprintf>
      walk_prova(vec,v,index+1,i);
80104429:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010442c:	50                   	push   %eax
8010442d:	ff 75 e0             	push   -0x20(%ebp)
80104430:	ff 75 0c             	push   0xc(%ebp)
80104433:	57                   	push   %edi
80104434:	e8 97 ff ff ff       	call   801043d0 <walk_prova>
      if(vec[i+1]!=-1){
80104439:	83 c4 20             	add    $0x20,%esp
8010443c:	83 3c 9f ff          	cmpl   $0xffffffff,(%edi,%ebx,4)
80104440:	74 be                	je     80104400 <walk_prova+0x30>
        for(j=i+1;j<NPROC;j++)
80104442:	83 fb 40             	cmp    $0x40,%ebx
80104445:	74 79                	je     801044c0 <walk_prova+0xf0>
80104447:	89 d8                	mov    %ebx,%eax
80104449:	eb 0d                	jmp    80104458 <walk_prova+0x88>
8010444b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010444f:	90                   	nop
80104450:	83 c0 01             	add    $0x1,%eax
80104453:	83 f8 40             	cmp    $0x40,%eax
80104456:	74 b1                	je     80104409 <walk_prova+0x39>
        {
          if(vec[j] == pid)
80104458:	39 34 87             	cmp    %esi,(%edi,%eax,4)
8010445b:	75 f3                	jne    80104450 <walk_prova+0x80>
            break;
          }
        }
        if(flag==1)
...
80104460:	68 86 7b 10 80       	push   $0x80107b86
80104465:	e8 36 c2 ff ff       	call   801006a0 <cprintf>
          for(j=0;j<index;j++)
8010446a:	8b 55 10             	mov    0x10(%ebp),%edx
8010446d:	83 c4 10             	add    $0x10,%esp
80104470:	31 c0                	xor    %eax,%eax
80104472:	85 d2                	test   %edx,%edx
80104474:	7e 93                	jle    80104409 <walk_prova+0x39>
80104476:	89 5d dc             	mov    %ebx,-0x24(%ebp)
80104479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010447c:	89 7d 08             	mov    %edi,0x8(%ebp)
8010447f:	8b 7d 10             	mov    0x10(%ebp),%edi
80104482:	89 75 14             	mov    %esi,0x14(%ebp)
80104485:	89 c6                	mov    %eax,%esi
80104487:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010448e:	66 90                	xchg   %ax,%ax
          {
            cprintf("->\t[PID: %d]\t",v[j]);
80104490:	83 ec 08             	sub    $0x8,%esp
80104493:	ff 34 b3             	push   (%ebx,%esi,4)
          for(j=0;j<index;j++)
80104496:	83 c6 01             	add    $0x1,%esi
            cprintf("->\t[PID: %d]\t",v[j]);
80104499:	68 78 7b 10 80       	push   $0x80107b78
8010449e:	e8 fd c1 ff ff       	call   801006a0 <cprintf>
          for(j=0;j<index;j++)
801044a3:	83 c4 10             	add    $0x10,%esp
801044a6:	39 f7                	cmp    %esi,%edi
801044a8:	75 e6                	jne    80104490 <walk_prova+0xc0>
801044aa:	8b 5d dc             	mov    -0x24(%ebp),%ebx
801044ad:	8b 7d 08             	mov    0x8(%ebp),%edi
801044b0:	8b 75 14             	mov    0x14(%ebp),%esi
        for(j=i+1;j<NPROC;j++)
801044b3:	89 d8                	mov    %ebx,%eax
801044b5:	e9 51 ff ff ff       	jmp    8010440b <walk_prova+0x3b>
...
801044d0 <getproctree>:

int
getproctree(void){
801044d0:	55                   	push   %ebp
801044d1:	89 e5                	mov    %esp,%ebp
801044d3:	81 ec 00 10 00 00    	sub    $0x1000,%esp
801044d9:	83 0c 24 00          	orl    $0x0,(%esp)
801044dd:	81 ec 14 0f 00 00    	sub    $0xf14,%esp
  acquire(&ptable.lock);
801044e3:	68 20 1d 11 80       	push   $0x80111d20
801044e8:	e8 13 04 00 00       	call   80104900 <acquire>
...
801044f0:	68 c0 1d 11 80       	push   $0x80111dc0
801044f5:	ff 35 64 1d 11 80    	push   0x80111d64
801044fb:	68 4e 7b 10 80       	push   $0x80107b4e
80104500:	e8 9b c1 ff ff       	call   801006a0 <cprintf>

  walk(ptable.proc,v,0,1);
80104505:	8d 85 f8 e0 ff ff    	lea    -0x1f08(%ebp),%eax
8010450b:	6a 01                	push   $0x1
8010450d:	6a 00                	push   $0x0
8010450f:	50                   	push   %eax
80104510:	68 54 1d 11 80       	push   $0x80111d54
80104515:	e8 66 fd ff ff       	call   80104280 <walk>

  cprintf("\n");
8010451a:	83 c4 14             	add    $0x14,%esp
8010451d:	68 ff 7e 10 80       	push   $0x80107eff
80104522:	e8 79 c1 ff ff       	call   801006a0 <cprintf>
  ...
  release(&ptable.lock);
80104527:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010452e:	e8 6d 03 00 00       	call   801048a0 <release>
  return 0;
}
...
80104549:	bb c0 1d 11 80       	mov    $0x80111dc0,%ebx
...
8010457c:	74 ea                	je     80104568 <procdump+0x28>
      state = "???";
8010457e:	ba 91 7b 10 80       	mov    $0x80107b91,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104583:	83 f8 05             	cmp    $0x5,%eax
80104586:	77 11                	ja     80104599 <procdump+0x59>
80104588:	8b 14 85 f0 7b 10 80 	mov    -0x7fef8410(,%eax,4),%edx
      state = "???";
8010458f:	b8 91 7b 10 80       	mov    $0x80107b91,%eax
...
8010459e:	68 95 7b 10 80       	push   $0x80107b95
...
801045c5:	e8 86 01 00 00       	call   80104750 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801045dd:	68 a1 75 10 80       	push   $0x801075a1
...
8010460a:	68 08 7c 10 80       	push   $0x80107c08
...
80104665:	e8 d6 f9 ff ff       	call   80104040 <sleep>
  while (lk->locked) {
...
80104673:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104679:	e8 f2 f2 ff ff       	call   80103970 <myproc>
...
801046c4:	e8 37 fa ff ff       	call   80104100 <wakeup>
  release(&lk->lk);
...
8010471b:	e8 50 f2 ff ff       	call   80103970 <myproc>
...
801047da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
801047e0:	e8 0b f1 ff ff       	call   801038f0 <mycpu>
...
8010480b:	75 35                	jne    80104842 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010480d:	e8 de f0 ff ff       	call   801038f0 <mycpu>
...
8010482c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104830:	e8 bb f0 ff ff       	call   801038f0 <mycpu>
...
80104845:	68 13 7c 10 80       	push   $0x80107c13
8010484a:	e8 31 bb ff ff       	call   80100380 <panic>
    panic("popcli");
8010484f:	83 ec 0c             	sub    $0xc,%esp
80104852:	68 2a 7c 10 80       	push   $0x80107c2a
...
80104883:	e8 68 f0 ff ff       	call   801038f0 <mycpu>
...
801048bb:	68 31 7c 10 80       	push   $0x80107c31
...
8010493c:	e8 af ef ff ff       	call   801038f0 <mycpu>
...
8010499b:	e8 50 ef ff ff       	call   801038f0 <mycpu>
...
801049b0:	68 39 7c 10 80       	push   $0x80107c39
...
80104bf7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104bfa:	e8 71 ed ff ff       	call   80103970 <myproc>
...
80104c37:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104c3a:	e8 31 ed ff ff       	call   80103970 <myproc>
...
80104cd6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104cd9:	e8 92 ec ff ff       	call   80103970 <myproc>
...
80104cee:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104cf1:	e8 7a ec ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d44:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104d45:	e8 26 ec ff ff       	call   80103970 <myproc>
...
80104d53:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104d56:	e8 15 ec ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104d6b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104d6e:	e8 fd eb ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80104dc4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104dc7:	e8 a4 eb ff ff       	call   80103970 <myproc>
...
80104dd7:	83 fa 16             	cmp    $0x16,%edx
80104dda:	77 24                	ja     80104e00 <syscall+0x40>
80104ddc:	8b 14 85 60 7c 10 80 	mov    -0x7fef83a0(,%eax,4),%edx
...
80104e08:	68 41 7c 10 80       	push   $0x80107c41
...
80104f64:	68 dc 7c 10 80       	push   $0x80107cdc
...
80104f7c:	68 db 7c 10 80       	push   $0x80107cdb
...
80104f91:	68 cf 7c 10 80       	push   $0x80107ccf
...
80104faf:	68 de 7c 10 80       	push   $0x80107cde
80104fb4:	e8 c7 b3 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104fb9:	83 ec 0c             	sub    $0xc,%esp
80104fbc:	68 c0 7c 10 80       	push   $0x80107cc0
...
80105181:	74 25                	je     801051a8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105183:	e8 e8 e7 ff ff       	call   80103970 <myproc>
  fileclose(f);
...
801051d0:	e8 9b e7 ff ff       	call   80103970 <myproc>
...
801053bd:	58                   	pop    %eax
801053be:	5a                   	pop    %edx
801053bf:	68 dc 7c 10 80       	push   $0x80107cdc
...
801053d8:	68 db 7c 10 80       	push   $0x80107cdb
...
80105785:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105788:	e8 e3 e1 ff ff       	call   80103970 <myproc>
...
80105957:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105959:	e8 12 e0 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105997:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010599a:	e8 d1 df ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
801059f0:	e9 1b e1 ff ff       	jmp    80103b10 <fork>
...
80105a03:	83 ec 08             	sub    $0x8,%esp
  exit();
80105a06:	e8 85 e3 ff ff       	call   80103d90 <exit>
...
{
  return wait();
80105a10:	e9 ab e4 ff ff       	jmp    80103ec0 <wait>
...
80105a3e:	e8 1d e7 ff ff       	call   80104160 <kill>
...
80105a63:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105a66:	e8 05 df ff ff       	call   80103970 <myproc>
...
80105a96:	e8 f5 df ff ff       	call   80103a90 <growproc>
...
80105aea:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105aed:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
...
80105b08:	68 60 3c 11 80       	push   $0x80113c60
80105b0d:	e8 2e e5 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105b12:	a1 60 3c 11 80       	mov    0x80113c60,%eax
...
80105b1f:	73 2f                	jae    80105b50 <sys_sleep+0x90>
    if(myproc()->killed){
80105b21:	e8 4a de ff ff       	call   80103970 <myproc>
...
80105b53:	68 80 3c 11 80       	push   $0x80113c80
...
80105b74:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105b77:	68 80 3c 11 80       	push   $0x80113c80
80105b7c:	e8 7f ed ff ff       	call   80104900 <acquire>
  xticks = ticks;
80105b81:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  release(&tickslock);
80105b87:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
...
80105ba9:	68 04 06 00 00       	push   $0x604
80105bae:	50                   	push   %eax
80105baf:	6a 00                	push   $0x0
80105bb1:	e8 1a f1 ff ff       	call   80104cd0 <argptr>
80105bb6:	83 c4 10             	add    $0x10,%esp
80105bb9:	85 c0                	test   %eax,%eax
80105bbb:	78 13                	js     80105bd0 <sys_getprocinfo+0x30>
      return -1;
  getprocinfo(d);
80105bbd:	83 ec 0c             	sub    $0xc,%esp
80105bc0:	ff 75 f4             	push   -0xc(%ebp)
80105bc3:	e8 18 e6 ff ff       	call   801041e0 <getprocinfo>
  return 0;
...
80105be3:	83 ec 08             	sub    $0x8,%esp
  getproctree();
80105be6:	e8 e5 e8 ff ff       	call   801044d0 <getproctree>
  return 0;
...
80105bf0:	06                   	push   %es
  pushl %fs
80105bf1:	0f a0                	push   %fs
  pushl %gs
80105bf3:	0f a8                	push   %gs
  pushal
80105bf5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105bf6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105bfa:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105bfc:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105bfe:	54                   	push   %esp
  call trap
80105bff:	e8 cc 00 00 00       	call   80105cd0 <trap>
  addl $4, %esp
80105c04:	83 c4 04             	add    $0x4,%esp
...
80105c07:	61                   	popa   
  popl %gs
80105c08:	0f a9                	pop    %gs
  popl %fs
80105c0a:	0f a1                	pop    %fs
  popl %es
80105c0c:	07                   	pop    %es
  popl %ds
80105c0d:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105c0e:	83 c4 08             	add    $0x8,%esp
  iret
80105c11:	cf                   	iret   
80105c12:	66 90                	xchg   %ax,%ax
...
80105c37:	c7 04 c5 c2 3c 11 80 	movl   $0x8e000008,-0x7feec33e(,%eax,8)
80105c3e:	08 00 00 8e 
80105c42:	66 89 14 c5 c0 3c 11 	mov    %dx,-0x7feec340(,%eax,8)
80105c49:	80 
80105c4a:	c1 ea 10             	shr    $0x10,%edx
80105c4d:	66 89 14 c5 c6 3c 11 	mov    %dx,-0x7feec33a(,%eax,8)
80105c54:	80 
  for(i = 0; i < 256; i++)
...
80105c5f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c62:	a1 08 a1 10 80       	mov    0x8010a108,%eax
80105c67:	c7 05 c2 3e 11 80 08 	movl   $0xef000008,0x80113ec2
80105c6e:	00 00 ef 
  initlock(&tickslock, "time");
80105c71:	68 21 7d 10 80       	push   $0x80107d21
80105c76:	68 80 3c 11 80       	push   $0x80113c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c7b:	66 a3 c0 3e 11 80    	mov    %ax,0x80113ec0
80105c81:	c1 e8 10             	shr    $0x10,%eax
80105c84:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
80105c8a:	e8 a1 ea ff ff       	call   80104730 <initlock>
}
...
80105cab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105caf:	b8 c0 3c 11 80       	mov    $0x80113cc0,%eax
...
80105cf4:	ff 24 85 c8 7d 10 80 	jmp    *-0x7fef8238(,%eax,4)
...
80105d42:	0f 84 b8 00 00 00    	je     80105e00 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d48:	e8 23 dc ff ff       	call   80103970 <myproc>
80105d4d:	85 c0                	test   %eax,%eax
80105d4f:	74 1d                	je     80105d6e <trap+0x9e>
80105d51:	e8 1a dc ff ff       	call   80103970 <myproc>
...
80105da0:	e8 ab db ff ff       	call   80103950 <cpuid>
...
80105db1:	e8 ba db ff ff       	call   80103970 <myproc>
...
80105dd5:	68 84 7d 10 80       	push   $0x80107d84
80105dda:	e8 c1 a8 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105ddf:	83 c4 20             	add    $0x20,%esp
80105de2:	e8 89 db ff ff       	call   80103970 <myproc>
80105de7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105dee:	e8 7d db ff ff       	call   80103970 <myproc>
...
80105e04:	0f 85 3e ff ff ff    	jne    80105d48 <trap+0x78>
    yield();
80105e0a:	e8 e1 e1 ff ff       	call   80103ff0 <yield>
...
80105e1f:	e8 2c db ff ff       	call   80103950 <cpuid>
80105e24:	57                   	push   %edi
80105e25:	56                   	push   %esi
80105e26:	50                   	push   %eax
80105e27:	68 2c 7d 10 80       	push   $0x80107d2c
80105e2c:	e8 6f a8 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105e31:	e8 da ca ff ff       	call   80102910 <lapiceoi>
    break;
...
80105e5a:	0f 85 c8 00 00 00    	jne    80105f28 <trap+0x258>
    myproc()->tf = tf;
80105e60:	e8 0b db ff ff       	call   80103970 <myproc>
80105e65:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105e68:	e8 53 ef ff ff       	call   80104dc0 <syscall>
    if(myproc()->killed)
80105e6d:	e8 fe da ff ff       	call   80103970 <myproc>
...
80105e83:	5d                   	pop    %ebp
      exit();
80105e84:	e9 07 df ff ff       	jmp    80103d90 <exit>
...
80105eac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105eb0:	e8 1b c9 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105eb5:	e8 56 ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105eba:	e8 b1 da ff ff       	call   80103970 <myproc>
...
80105ecc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105ed0:	e8 7b da ff ff       	call   80103950 <cpuid>
80105ed5:	85 c0                	test   %eax,%eax
80105ed7:	0f 85 28 fe ff ff    	jne    80105d05 <trap+0x35>
      acquire(&tickslock);
80105edd:	83 ec 0c             	sub    $0xc,%esp
80105ee0:	68 80 3c 11 80       	push   $0x80113c80
80105ee5:	e8 16 ea ff ff       	call   80104900 <acquire>
      wakeup(&ticks);
80105eea:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105ef1:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105ef8:	e8 03 e2 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105efd:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105f04:	e8 97 e9 ff ff       	call   801048a0 <release>
...
80105fe7:	74 78                	je     80106061 <uartinit+0xd1>
  uart = 1;
80105fe9:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105ff0:	00 00 00 
...
80105ffc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105fff:	bf 48 7e 10 80       	mov    $0x80107e48,%edi
...
80106019:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106020:	a1 c0 44 11 80       	mov    0x801144c0,%eax
...
80106070 <uartputc>:
  if(!uart)
80106070:	a1 c0 44 11 80       	mov    0x801144c0,%eax
...
80106095:	e8 96 c8 ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
801060e7:	6a 00                	push   $0x0
  jmp alltraps
801060e9:	e9 01 fb ff ff       	jmp    80105bef <alltraps>
...
801060f0:	6a 01                	push   $0x1
  jmp alltraps
801060f2:	e9 f8 fa ff ff       	jmp    80105bef <alltraps>
...
801060f9:	6a 02                	push   $0x2
  jmp alltraps
801060fb:	e9 ef fa ff ff       	jmp    80105bef <alltraps>
...
80106102:	6a 03                	push   $0x3
  jmp alltraps
80106104:	e9 e6 fa ff ff       	jmp    80105bef <alltraps>
...
8010610b:	6a 04                	push   $0x4
  jmp alltraps
8010610d:	e9 dd fa ff ff       	jmp    80105bef <alltraps>
...
80106114:	6a 05                	push   $0x5
  jmp alltraps
80106116:	e9 d4 fa ff ff       	jmp    80105bef <alltraps>
...
8010611d:	6a 06                	push   $0x6
  jmp alltraps
8010611f:	e9 cb fa ff ff       	jmp    80105bef <alltraps>
...
80106126:	6a 07                	push   $0x7
  jmp alltraps
80106128:	e9 c2 fa ff ff       	jmp    80105bef <alltraps>
...
8010612d:	6a 08                	push   $0x8
  jmp alltraps
8010612f:	e9 bb fa ff ff       	jmp    80105bef <alltraps>
...
80106136:	6a 09                	push   $0x9
  jmp alltraps
80106138:	e9 b2 fa ff ff       	jmp    80105bef <alltraps>
...
8010613d:	6a 0a                	push   $0xa
  jmp alltraps
8010613f:	e9 ab fa ff ff       	jmp    80105bef <alltraps>
...
80106144:	6a 0b                	push   $0xb
  jmp alltraps
80106146:	e9 a4 fa ff ff       	jmp    80105bef <alltraps>
...
8010614b:	6a 0c                	push   $0xc
  jmp alltraps
8010614d:	e9 9d fa ff ff       	jmp    80105bef <alltraps>
...
80106152:	6a 0d                	push   $0xd
  jmp alltraps
80106154:	e9 96 fa ff ff       	jmp    80105bef <alltraps>
...
80106159:	6a 0e                	push   $0xe
  jmp alltraps
8010615b:	e9 8f fa ff ff       	jmp    80105bef <alltraps>
...
80106162:	6a 0f                	push   $0xf
  jmp alltraps
80106164:	e9 86 fa ff ff       	jmp    80105bef <alltraps>
...
8010616b:	6a 10                	push   $0x10
  jmp alltraps
8010616d:	e9 7d fa ff ff       	jmp    80105bef <alltraps>
...
80106172:	6a 11                	push   $0x11
  jmp alltraps
80106174:	e9 76 fa ff ff       	jmp    80105bef <alltraps>
...
8010617b:	6a 12                	push   $0x12
  jmp alltraps
8010617d:	e9 6d fa ff ff       	jmp    80105bef <alltraps>
...
80106184:	6a 13                	push   $0x13
  jmp alltraps
80106186:	e9 64 fa ff ff       	jmp    80105bef <alltraps>
...
8010618d:	6a 14                	push   $0x14
  jmp alltraps
8010618f:	e9 5b fa ff ff       	jmp    80105bef <alltraps>
...
80106196:	6a 15                	push   $0x15
  jmp alltraps
80106198:	e9 52 fa ff ff       	jmp    80105bef <alltraps>
...
8010619f:	6a 16                	push   $0x16
  jmp alltraps
801061a1:	e9 49 fa ff ff       	jmp    80105bef <alltraps>
...
801061a8:	6a 17                	push   $0x17
  jmp alltraps
801061aa:	e9 40 fa ff ff       	jmp    80105bef <alltraps>
...
801061b1:	6a 18                	push   $0x18
  jmp alltraps
801061b3:	e9 37 fa ff ff       	jmp    80105bef <alltraps>
...
801061ba:	6a 19                	push   $0x19
  jmp alltraps
801061bc:	e9 2e fa ff ff       	jmp    80105bef <alltraps>
...
801061c3:	6a 1a                	push   $0x1a
  jmp alltraps
801061c5:	e9 25 fa ff ff       	jmp    80105bef <alltraps>
...
801061cc:	6a 1b                	push   $0x1b
  jmp alltraps
801061ce:	e9 1c fa ff ff       	jmp    80105bef <alltraps>
...
801061d5:	6a 1c                	push   $0x1c
  jmp alltraps
801061d7:	e9 13 fa ff ff       	jmp    80105bef <alltraps>
...
801061de:	6a 1d                	push   $0x1d
  jmp alltraps
801061e0:	e9 0a fa ff ff       	jmp    80105bef <alltraps>
...
801061e7:	6a 1e                	push   $0x1e
  jmp alltraps
801061e9:	e9 01 fa ff ff       	jmp    80105bef <alltraps>
...
801061f0:	6a 1f                	push   $0x1f
  jmp alltraps
801061f2:	e9 f8 f9 ff ff       	jmp    80105bef <alltraps>
...
801061f9:	6a 20                	push   $0x20
  jmp alltraps
801061fb:	e9 ef f9 ff ff       	jmp    80105bef <alltraps>
...
80106202:	6a 21                	push   $0x21
  jmp alltraps
80106204:	e9 e6 f9 ff ff       	jmp    80105bef <alltraps>
...
8010620b:	6a 22                	push   $0x22
  jmp alltraps
8010620d:	e9 dd f9 ff ff       	jmp    80105bef <alltraps>
...
80106214:	6a 23                	push   $0x23
  jmp alltraps
80106216:	e9 d4 f9 ff ff       	jmp    80105bef <alltraps>
...
8010621d:	6a 24                	push   $0x24
  jmp alltraps
8010621f:	e9 cb f9 ff ff       	jmp    80105bef <alltraps>
...
80106226:	6a 25                	push   $0x25
  jmp alltraps
80106228:	e9 c2 f9 ff ff       	jmp    80105bef <alltraps>
...
8010622f:	6a 26                	push   $0x26
  jmp alltraps
80106231:	e9 b9 f9 ff ff       	jmp    80105bef <alltraps>
...
80106238:	6a 27                	push   $0x27
  jmp alltraps
8010623a:	e9 b0 f9 ff ff       	jmp    80105bef <alltraps>
...
80106241:	6a 28                	push   $0x28
  jmp alltraps
80106243:	e9 a7 f9 ff ff       	jmp    80105bef <alltraps>
...
8010624a:	6a 29                	push   $0x29
  jmp alltraps
8010624c:	e9 9e f9 ff ff       	jmp    80105bef <alltraps>
...
80106253:	6a 2a                	push   $0x2a
  jmp alltraps
80106255:	e9 95 f9 ff ff       	jmp    80105bef <alltraps>
...
8010625c:	6a 2b                	push   $0x2b
  jmp alltraps
8010625e:	e9 8c f9 ff ff       	jmp    80105bef <alltraps>
...
80106265:	6a 2c                	push   $0x2c
  jmp alltraps
80106267:	e9 83 f9 ff ff       	jmp    80105bef <alltraps>
...
8010626e:	6a 2d                	push   $0x2d
  jmp alltraps
80106270:	e9 7a f9 ff ff       	jmp    80105bef <alltraps>
...
80106277:	6a 2e                	push   $0x2e
  jmp alltraps
80106279:	e9 71 f9 ff ff       	jmp    80105bef <alltraps>
...
80106280:	6a 2f                	push   $0x2f
  jmp alltraps
80106282:	e9 68 f9 ff ff       	jmp    80105bef <alltraps>
...
80106289:	6a 30                	push   $0x30
  jmp alltraps
8010628b:	e9 5f f9 ff ff       	jmp    80105bef <alltraps>
...
80106292:	6a 31                	push   $0x31
  jmp alltraps
80106294:	e9 56 f9 ff ff       	jmp    80105bef <alltraps>
...
8010629b:	6a 32                	push   $0x32
  jmp alltraps
8010629d:	e9 4d f9 ff ff       	jmp    80105bef <alltraps>
...
801062a4:	6a 33                	push   $0x33
  jmp alltraps
801062a6:	e9 44 f9 ff ff       	jmp    80105bef <alltraps>
...
801062ad:	6a 34                	push   $0x34
  jmp alltraps
801062af:	e9 3b f9 ff ff       	jmp    80105bef <alltraps>
...
801062b6:	6a 35                	push   $0x35
  jmp alltraps
801062b8:	e9 32 f9 ff ff       	jmp    80105bef <alltraps>
...
801062bf:	6a 36                	push   $0x36
  jmp alltraps
801062c1:	e9 29 f9 ff ff       	jmp    80105bef <alltraps>
...
801062c8:	6a 37                	push   $0x37
  jmp alltraps
801062ca:	e9 20 f9 ff ff       	jmp    80105bef <alltraps>
...
801062d1:	6a 38                	push   $0x38
  jmp alltraps
801062d3:	e9 17 f9 ff ff       	jmp    80105bef <alltraps>
...
801062da:	6a 39                	push   $0x39
  jmp alltraps
801062dc:	e9 0e f9 ff ff       	jmp    80105bef <alltraps>
...
801062e3:	6a 3a                	push   $0x3a
  jmp alltraps
801062e5:	e9 05 f9 ff ff       	jmp    80105bef <alltraps>
...
801062ec:	6a 3b                	push   $0x3b
  jmp alltraps
801062ee:	e9 fc f8 ff ff       	jmp    80105bef <alltraps>
...
801062f5:	6a 3c                	push   $0x3c
  jmp alltraps
801062f7:	e9 f3 f8 ff ff       	jmp    80105bef <alltraps>
...
801062fe:	6a 3d                	push   $0x3d
  jmp alltraps
80106300:	e9 ea f8 ff ff       	jmp    80105bef <alltraps>
...
80106307:	6a 3e                	push   $0x3e
  jmp alltraps
80106309:	e9 e1 f8 ff ff       	jmp    80105bef <alltraps>
...
80106310:	6a 3f                	push   $0x3f
  jmp alltraps
80106312:	e9 d8 f8 ff ff       	jmp    80105bef <alltraps>
...
80106319:	6a 40                	push   $0x40
  jmp alltraps
8010631b:	e9 cf f8 ff ff       	jmp    80105bef <alltraps>
...
80106322:	6a 41                	push   $0x41
  jmp alltraps
80106324:	e9 c6 f8 ff ff       	jmp    80105bef <alltraps>
...
8010632b:	6a 42                	push   $0x42
  jmp alltraps
8010632d:	e9 bd f8 ff ff       	jmp    80105bef <alltraps>
...
80106334:	6a 43                	push   $0x43
  jmp alltraps
80106336:	e9 b4 f8 ff ff       	jmp    80105bef <alltraps>
...
8010633d:	6a 44                	push   $0x44
  jmp alltraps
8010633f:	e9 ab f8 ff ff       	jmp    80105bef <alltraps>
...
80106346:	6a 45                	push   $0x45
  jmp alltraps
80106348:	e9 a2 f8 ff ff       	jmp    80105bef <alltraps>
...
8010634f:	6a 46                	push   $0x46
  jmp alltraps
80106351:	e9 99 f8 ff ff       	jmp    80105bef <alltraps>
...
80106358:	6a 47                	push   $0x47
  jmp alltraps
8010635a:	e9 90 f8 ff ff       	jmp    80105bef <alltraps>
...
80106361:	6a 48                	push   $0x48
  jmp alltraps
80106363:	e9 87 f8 ff ff       	jmp    80105bef <alltraps>
...
8010636a:	6a 49                	push   $0x49
  jmp alltraps
8010636c:	e9 7e f8 ff ff       	jmp    80105bef <alltraps>
...
80106373:	6a 4a                	push   $0x4a
  jmp alltraps
80106375:	e9 75 f8 ff ff       	jmp    80105bef <alltraps>
...
8010637c:	6a 4b                	push   $0x4b
  jmp alltraps
8010637e:	e9 6c f8 ff ff       	jmp    80105bef <alltraps>
...
80106385:	6a 4c                	push   $0x4c
  jmp alltraps
80106387:	e9 63 f8 ff ff       	jmp    80105bef <alltraps>
...
8010638e:	6a 4d                	push   $0x4d
  jmp alltraps
80106390:	e9 5a f8 ff ff       	jmp    80105bef <alltraps>
...
80106397:	6a 4e                	push   $0x4e
  jmp alltraps
80106399:	e9 51 f8 ff ff       	jmp    80105bef <alltraps>
...
801063a0:	6a 4f                	push   $0x4f
  jmp alltraps
801063a2:	e9 48 f8 ff ff       	jmp    80105bef <alltraps>
...
801063a9:	6a 50                	push   $0x50
  jmp alltraps
801063ab:	e9 3f f8 ff ff       	jmp    80105bef <alltraps>
...
801063b2:	6a 51                	push   $0x51
  jmp alltraps
801063b4:	e9 36 f8 ff ff       	jmp    80105bef <alltraps>
...
801063bb:	6a 52                	push   $0x52
  jmp alltraps
801063bd:	e9 2d f8 ff ff       	jmp    80105bef <alltraps>
...
801063c4:	6a 53                	push   $0x53
  jmp alltraps
801063c6:	e9 24 f8 ff ff       	jmp    80105bef <alltraps>
...
801063cd:	6a 54                	push   $0x54
  jmp alltraps
801063cf:	e9 1b f8 ff ff       	jmp    80105bef <alltraps>
...
801063d6:	6a 55                	push   $0x55
  jmp alltraps
801063d8:	e9 12 f8 ff ff       	jmp    80105bef <alltraps>
...
801063df:	6a 56                	push   $0x56
  jmp alltraps
801063e1:	e9 09 f8 ff ff       	jmp    80105bef <alltraps>
...
801063e8:	6a 57                	push   $0x57
  jmp alltraps
801063ea:	e9 00 f8 ff ff       	jmp    80105bef <alltraps>
...
801063f1:	6a 58                	push   $0x58
  jmp alltraps
801063f3:	e9 f7 f7 ff ff       	jmp    80105bef <alltraps>
...
801063fa:	6a 59                	push   $0x59
  jmp alltraps
801063fc:	e9 ee f7 ff ff       	jmp    80105bef <alltraps>
...
80106403:	6a 5a                	push   $0x5a
  jmp alltraps
80106405:	e9 e5 f7 ff ff       	jmp    80105bef <alltraps>
...
8010640c:	6a 5b                	push   $0x5b
  jmp alltraps
8010640e:	e9 dc f7 ff ff       	jmp    80105bef <alltraps>
...
80106415:	6a 5c                	push   $0x5c
  jmp alltraps
80106417:	e9 d3 f7 ff ff       	jmp    80105bef <alltraps>
...
8010641e:	6a 5d                	push   $0x5d
  jmp alltraps
80106420:	e9 ca f7 ff ff       	jmp    80105bef <alltraps>
...
80106427:	6a 5e                	push   $0x5e
  jmp alltraps
80106429:	e9 c1 f7 ff ff       	jmp    80105bef <alltraps>
...
80106430:	6a 5f                	push   $0x5f
  jmp alltraps
80106432:	e9 b8 f7 ff ff       	jmp    80105bef <alltraps>
...
80106439:	6a 60                	push   $0x60
  jmp alltraps
8010643b:	e9 af f7 ff ff       	jmp    80105bef <alltraps>
...
80106442:	6a 61                	push   $0x61
  jmp alltraps
80106444:	e9 a6 f7 ff ff       	jmp    80105bef <alltraps>
...
8010644b:	6a 62                	push   $0x62
  jmp alltraps
8010644d:	e9 9d f7 ff ff       	jmp    80105bef <alltraps>
...
80106454:	6a 63                	push   $0x63
  jmp alltraps
80106456:	e9 94 f7 ff ff       	jmp    80105bef <alltraps>
...
8010645d:	6a 64                	push   $0x64
  jmp alltraps
8010645f:	e9 8b f7 ff ff       	jmp    80105bef <alltraps>
...
80106466:	6a 65                	push   $0x65
  jmp alltraps
80106468:	e9 82 f7 ff ff       	jmp    80105bef <alltraps>
...
8010646f:	6a 66                	push   $0x66
  jmp alltraps
80106471:	e9 79 f7 ff ff       	jmp    80105bef <alltraps>
...
80106478:	6a 67                	push   $0x67
  jmp alltraps
8010647a:	e9 70 f7 ff ff       	jmp    80105bef <alltraps>
...
80106481:	6a 68                	push   $0x68
  jmp alltraps
80106483:	e9 67 f7 ff ff       	jmp    80105bef <alltraps>
...
8010648a:	6a 69                	push   $0x69
  jmp alltraps
8010648c:	e9 5e f7 ff ff       	jmp    80105bef <alltraps>
...
80106493:	6a 6a                	push   $0x6a
  jmp alltraps
80106495:	e9 55 f7 ff ff       	jmp    80105bef <alltraps>
...
8010649c:	6a 6b                	push   $0x6b
  jmp alltraps
8010649e:	e9 4c f7 ff ff       	jmp    80105bef <alltraps>
...
801064a5:	6a 6c                	push   $0x6c
  jmp alltraps
801064a7:	e9 43 f7 ff ff       	jmp    80105bef <alltraps>
...
801064ae:	6a 6d                	push   $0x6d
  jmp alltraps
801064b0:	e9 3a f7 ff ff       	jmp    80105bef <alltraps>
...
801064b7:	6a 6e                	push   $0x6e
  jmp alltraps
801064b9:	e9 31 f7 ff ff       	jmp    80105bef <alltraps>
...
801064c0:	6a 6f                	push   $0x6f
  jmp alltraps
801064c2:	e9 28 f7 ff ff       	jmp    80105bef <alltraps>
...
801064c9:	6a 70                	push   $0x70
  jmp alltraps
801064cb:	e9 1f f7 ff ff       	jmp    80105bef <alltraps>
...
801064d2:	6a 71                	push   $0x71
  jmp alltraps
801064d4:	e9 16 f7 ff ff       	jmp    80105bef <alltraps>
...
801064db:	6a 72                	push   $0x72
  jmp alltraps
801064dd:	e9 0d f7 ff ff       	jmp    80105bef <alltraps>
...
801064e4:	6a 73                	push   $0x73
  jmp alltraps
801064e6:	e9 04 f7 ff ff       	jmp    80105bef <alltraps>
...
801064ed:	6a 74                	push   $0x74
  jmp alltraps
801064ef:	e9 fb f6 ff ff       	jmp    80105bef <alltraps>
...
801064f6:	6a 75                	push   $0x75
  jmp alltraps
801064f8:	e9 f2 f6 ff ff       	jmp    80105bef <alltraps>
...
801064ff:	6a 76                	push   $0x76
  jmp alltraps
80106501:	e9 e9 f6 ff ff       	jmp    80105bef <alltraps>
...
80106508:	6a 77                	push   $0x77
  jmp alltraps
8010650a:	e9 e0 f6 ff ff       	jmp    80105bef <alltraps>
...
80106511:	6a 78                	push   $0x78
  jmp alltraps
80106513:	e9 d7 f6 ff ff       	jmp    80105bef <alltraps>
...
8010651a:	6a 79                	push   $0x79
  jmp alltraps
8010651c:	e9 ce f6 ff ff       	jmp    80105bef <alltraps>
...
80106523:	6a 7a                	push   $0x7a
  jmp alltraps
80106525:	e9 c5 f6 ff ff       	jmp    80105bef <alltraps>
...
8010652c:	6a 7b                	push   $0x7b
  jmp alltraps
8010652e:	e9 bc f6 ff ff       	jmp    80105bef <alltraps>
...
80106535:	6a 7c                	push   $0x7c
  jmp alltraps
80106537:	e9 b3 f6 ff ff       	jmp    80105bef <alltraps>
...
8010653e:	6a 7d                	push   $0x7d
  jmp alltraps
80106540:	e9 aa f6 ff ff       	jmp    80105bef <alltraps>
...
80106547:	6a 7e                	push   $0x7e
  jmp alltraps
80106549:	e9 a1 f6 ff ff       	jmp    80105bef <alltraps>
...
80106550:	6a 7f                	push   $0x7f
  jmp alltraps
80106552:	e9 98 f6 ff ff       	jmp    80105bef <alltraps>
...
80106559:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010655e:	e9 8c f6 ff ff       	jmp    80105bef <alltraps>
...
80106565:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010656a:	e9 80 f6 ff ff       	jmp    80105bef <alltraps>
...
80106571:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106576:	e9 74 f6 ff ff       	jmp    80105bef <alltraps>
...
8010657d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106582:	e9 68 f6 ff ff       	jmp    80105bef <alltraps>
...
80106589:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010658e:	e9 5c f6 ff ff       	jmp    80105bef <alltraps>
...
80106595:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010659a:	e9 50 f6 ff ff       	jmp    80105bef <alltraps>
...
801065a1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801065a6:	e9 44 f6 ff ff       	jmp    80105bef <alltraps>
...
801065ad:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801065b2:	e9 38 f6 ff ff       	jmp    80105bef <alltraps>
...
801065b9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801065be:	e9 2c f6 ff ff       	jmp    80105bef <alltraps>
...
801065c5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801065ca:	e9 20 f6 ff ff       	jmp    80105bef <alltraps>
...
801065d1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801065d6:	e9 14 f6 ff ff       	jmp    80105bef <alltraps>
...
801065dd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801065e2:	e9 08 f6 ff ff       	jmp    80105bef <alltraps>
...
801065e9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801065ee:	e9 fc f5 ff ff       	jmp    80105bef <alltraps>
...
801065f5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801065fa:	e9 f0 f5 ff ff       	jmp    80105bef <alltraps>
...
80106601:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106606:	e9 e4 f5 ff ff       	jmp    80105bef <alltraps>
...
8010660d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106612:	e9 d8 f5 ff ff       	jmp    80105bef <alltraps>
...
80106619:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010661e:	e9 cc f5 ff ff       	jmp    80105bef <alltraps>
...
80106625:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010662a:	e9 c0 f5 ff ff       	jmp    80105bef <alltraps>
...
80106631:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106636:	e9 b4 f5 ff ff       	jmp    80105bef <alltraps>
...
8010663d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106642:	e9 a8 f5 ff ff       	jmp    80105bef <alltraps>
...
80106649:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010664e:	e9 9c f5 ff ff       	jmp    80105bef <alltraps>
...
80106655:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010665a:	e9 90 f5 ff ff       	jmp    80105bef <alltraps>
...
80106661:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106666:	e9 84 f5 ff ff       	jmp    80105bef <alltraps>
...
8010666d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106672:	e9 78 f5 ff ff       	jmp    80105bef <alltraps>
...
80106679:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010667e:	e9 6c f5 ff ff       	jmp    80105bef <alltraps>
...
80106685:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010668a:	e9 60 f5 ff ff       	jmp    80105bef <alltraps>
...
80106691:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106696:	e9 54 f5 ff ff       	jmp    80105bef <alltraps>
...
8010669d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801066a2:	e9 48 f5 ff ff       	jmp    80105bef <alltraps>
...
801066a9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801066ae:	e9 3c f5 ff ff       	jmp    80105bef <alltraps>
...
801066b5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801066ba:	e9 30 f5 ff ff       	jmp    80105bef <alltraps>
...
801066c1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801066c6:	e9 24 f5 ff ff       	jmp    80105bef <alltraps>
...
801066cd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801066d2:	e9 18 f5 ff ff       	jmp    80105bef <alltraps>
...
801066d9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801066de:	e9 0c f5 ff ff       	jmp    80105bef <alltraps>
...
801066e5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801066ea:	e9 00 f5 ff ff       	jmp    80105bef <alltraps>
...
801066f1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801066f6:	e9 f4 f4 ff ff       	jmp    80105bef <alltraps>
...
801066fd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106702:	e9 e8 f4 ff ff       	jmp    80105bef <alltraps>
...
80106709:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010670e:	e9 dc f4 ff ff       	jmp    80105bef <alltraps>
...
80106715:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010671a:	e9 d0 f4 ff ff       	jmp    80105bef <alltraps>
...
80106721:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106726:	e9 c4 f4 ff ff       	jmp    80105bef <alltraps>
...
8010672d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106732:	e9 b8 f4 ff ff       	jmp    80105bef <alltraps>
...
80106739:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010673e:	e9 ac f4 ff ff       	jmp    80105bef <alltraps>
...
80106745:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010674a:	e9 a0 f4 ff ff       	jmp    80105bef <alltraps>
...
80106751:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106756:	e9 94 f4 ff ff       	jmp    80105bef <alltraps>
...
8010675d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106762:	e9 88 f4 ff ff       	jmp    80105bef <alltraps>
...
80106769:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010676e:	e9 7c f4 ff ff       	jmp    80105bef <alltraps>
...
80106775:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010677a:	e9 70 f4 ff ff       	jmp    80105bef <alltraps>
...
80106781:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106786:	e9 64 f4 ff ff       	jmp    80105bef <alltraps>
...
8010678d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106792:	e9 58 f4 ff ff       	jmp    80105bef <alltraps>
...
80106799:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010679e:	e9 4c f4 ff ff       	jmp    80105bef <alltraps>
...
801067a5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801067aa:	e9 40 f4 ff ff       	jmp    80105bef <alltraps>
...
801067b1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801067b6:	e9 34 f4 ff ff       	jmp    80105bef <alltraps>
...
801067bd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801067c2:	e9 28 f4 ff ff       	jmp    80105bef <alltraps>
...
801067c9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801067ce:	e9 1c f4 ff ff       	jmp    80105bef <alltraps>
...
801067d5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801067da:	e9 10 f4 ff ff       	jmp    80105bef <alltraps>
...
801067e1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801067e6:	e9 04 f4 ff ff       	jmp    80105bef <alltraps>
...
801067ed:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801067f2:	e9 f8 f3 ff ff       	jmp    80105bef <alltraps>
...
801067f9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801067fe:	e9 ec f3 ff ff       	jmp    80105bef <alltraps>
...
80106805:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010680a:	e9 e0 f3 ff ff       	jmp    80105bef <alltraps>
...
80106811:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106816:	e9 d4 f3 ff ff       	jmp    80105bef <alltraps>
...
8010681d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106822:	e9 c8 f3 ff ff       	jmp    80105bef <alltraps>
...
80106829:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010682e:	e9 bc f3 ff ff       	jmp    80105bef <alltraps>
...
80106835:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010683a:	e9 b0 f3 ff ff       	jmp    80105bef <alltraps>
...
80106841:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106846:	e9 a4 f3 ff ff       	jmp    80105bef <alltraps>
...
8010684d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106852:	e9 98 f3 ff ff       	jmp    80105bef <alltraps>
...
80106859:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010685e:	e9 8c f3 ff ff       	jmp    80105bef <alltraps>
...
80106865:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010686a:	e9 80 f3 ff ff       	jmp    80105bef <alltraps>
...
80106871:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106876:	e9 74 f3 ff ff       	jmp    80105bef <alltraps>
...
8010687d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106882:	e9 68 f3 ff ff       	jmp    80105bef <alltraps>
...
80106889:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010688e:	e9 5c f3 ff ff       	jmp    80105bef <alltraps>
...
80106895:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010689a:	e9 50 f3 ff ff       	jmp    80105bef <alltraps>
...
801068a1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801068a6:	e9 44 f3 ff ff       	jmp    80105bef <alltraps>
...
801068ad:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801068b2:	e9 38 f3 ff ff       	jmp    80105bef <alltraps>
...
801068b9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801068be:	e9 2c f3 ff ff       	jmp    80105bef <alltraps>
...
801068c5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801068ca:	e9 20 f3 ff ff       	jmp    80105bef <alltraps>
...
801068d1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801068d6:	e9 14 f3 ff ff       	jmp    80105bef <alltraps>
...
801068dd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801068e2:	e9 08 f3 ff ff       	jmp    80105bef <alltraps>
...
801068e9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801068ee:	e9 fc f2 ff ff       	jmp    80105bef <alltraps>
...
801068f5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801068fa:	e9 f0 f2 ff ff       	jmp    80105bef <alltraps>
...
80106901:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106906:	e9 e4 f2 ff ff       	jmp    80105bef <alltraps>
...
8010690d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106912:	e9 d8 f2 ff ff       	jmp    80105bef <alltraps>
...
80106919:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010691e:	e9 cc f2 ff ff       	jmp    80105bef <alltraps>
...
80106925:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010692a:	e9 c0 f2 ff ff       	jmp    80105bef <alltraps>
...
80106931:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106936:	e9 b4 f2 ff ff       	jmp    80105bef <alltraps>
...
8010693d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106942:	e9 a8 f2 ff ff       	jmp    80105bef <alltraps>
...
80106949:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010694e:	e9 9c f2 ff ff       	jmp    80105bef <alltraps>
...
80106955:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010695a:	e9 90 f2 ff ff       	jmp    80105bef <alltraps>
...
80106961:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106966:	e9 84 f2 ff ff       	jmp    80105bef <alltraps>
...
8010696d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106972:	e9 78 f2 ff ff       	jmp    80105bef <alltraps>
...
80106979:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010697e:	e9 6c f2 ff ff       	jmp    80105bef <alltraps>
...
80106985:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010698a:	e9 60 f2 ff ff       	jmp    80105bef <alltraps>
...
80106991:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106996:	e9 54 f2 ff ff       	jmp    80105bef <alltraps>
...
8010699d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801069a2:	e9 48 f2 ff ff       	jmp    80105bef <alltraps>
...
801069a9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801069ae:	e9 3c f2 ff ff       	jmp    80105bef <alltraps>
...
801069b5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801069ba:	e9 30 f2 ff ff       	jmp    80105bef <alltraps>
...
801069c1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801069c6:	e9 24 f2 ff ff       	jmp    80105bef <alltraps>
...
801069cd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801069d2:	e9 18 f2 ff ff       	jmp    80105bef <alltraps>
...
801069d9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801069de:	e9 0c f2 ff ff       	jmp    80105bef <alltraps>
...
801069e5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801069ea:	e9 00 f2 ff ff       	jmp    80105bef <alltraps>
...
801069f1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801069f6:	e9 f4 f1 ff ff       	jmp    80105bef <alltraps>
...
801069fd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106a02:	e9 e8 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a09:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106a0e:	e9 dc f1 ff ff       	jmp    80105bef <alltraps>
...
80106a15:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106a1a:	e9 d0 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a21:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106a26:	e9 c4 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a2d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106a32:	e9 b8 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a39:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106a3e:	e9 ac f1 ff ff       	jmp    80105bef <alltraps>
...
80106a45:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106a4a:	e9 a0 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a51:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106a56:	e9 94 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a5d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106a62:	e9 88 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a69:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106a6e:	e9 7c f1 ff ff       	jmp    80105bef <alltraps>
...
80106a75:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a7a:	e9 70 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a81:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a86:	e9 64 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a8d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106a92:	e9 58 f1 ff ff       	jmp    80105bef <alltraps>
...
80106a99:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106a9e:	e9 4c f1 ff ff       	jmp    80105bef <alltraps>
...
80106aa5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106aaa:	e9 40 f1 ff ff       	jmp    80105bef <alltraps>
...
80106ab1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106ab6:	e9 34 f1 ff ff       	jmp    80105bef <alltraps>
...
80106abd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106ac2:	e9 28 f1 ff ff       	jmp    80105bef <alltraps>
...
80106ac9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106ace:	e9 1c f1 ff ff       	jmp    80105bef <alltraps>
...
80106ad5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106ada:	e9 10 f1 ff ff       	jmp    80105bef <alltraps>
...
80106ae1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106ae6:	e9 04 f1 ff ff       	jmp    80105bef <alltraps>
...
80106aed:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106af2:	e9 f8 f0 ff ff       	jmp    80105bef <alltraps>
...
80106af9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106afe:	e9 ec f0 ff ff       	jmp    80105bef <alltraps>
...
80106b05:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106b0a:	e9 e0 f0 ff ff       	jmp    80105bef <alltraps>
...
80106b11:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106b16:	e9 d4 f0 ff ff       	jmp    80105bef <alltraps>
...
80106b1d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106b22:	e9 c8 f0 ff ff       	jmp    80105bef <alltraps>
...
80106b29:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106b2e:	e9 bc f0 ff ff       	jmp    80105bef <alltraps>
...
80106b35:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106b3a:	e9 b0 f0 ff ff       	jmp    80105bef <alltraps>
...
80106b41:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106b46:	e9 a4 f0 ff ff       	jmp    80105bef <alltraps>
...
80106b4d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106b52:	e9 98 f0 ff ff       	jmp    80105bef <alltraps>
...
80106bff:	68 c6 77 10 80       	push   $0x801077c6
...
80106c8e:	e8 ed b9 ff ff       	call   80102680 <kalloc>
...
80106ca5:	e8 16 dd ff ff       	call   801049c0 <memset>
...
80106ced:	68 50 7e 10 80       	push   $0x80107e50
...
80106d03:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106d06:	e8 45 cc ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106d1a:	c7 80 18 18 11 80 ff 	movl   $0xffff,-0x7feee7e8(%eax)
80106d21:	ff 00 00 
80106d24:	c7 80 1c 18 11 80 00 	movl   $0xcf9a00,-0x7feee7e4(%eax)
80106d2b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106d2e:	c7 80 20 18 11 80 ff 	movl   $0xffff,-0x7feee7e0(%eax)
80106d35:	ff 00 00 
80106d38:	c7 80 24 18 11 80 00 	movl   $0xcf9200,-0x7feee7dc(%eax)
80106d3f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106d42:	c7 80 28 18 11 80 ff 	movl   $0xffff,-0x7feee7d8(%eax)
80106d49:	ff 00 00 
80106d4c:	c7 80 2c 18 11 80 00 	movl   $0xcffa00,-0x7feee7d4(%eax)
80106d53:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106d56:	c7 80 30 18 11 80 ff 	movl   $0xffff,-0x7feee7d0(%eax)
80106d5d:	ff 00 00 
80106d60:	c7 80 34 18 11 80 00 	movl   $0xcff200,-0x7feee7cc(%eax)
80106d67:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106d6a:	05 10 18 11 80       	add    $0x80111810,%eax
  pd[1] = (uint)p;
...
80106d90:	a1 c4 44 11 80       	mov    0x801144c4,%eax
...
80106dc4:	0f 84 c2 00 00 00    	je     80106e8c <switchuvm+0xec>
  pushcli();
80106dca:	e8 e1 d9 ff ff       	call   801047b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106dcf:	e8 1c cb ff ff       	call   801038f0 <mycpu>
80106dd4:	89 c3                	mov    %eax,%ebx
80106dd6:	e8 15 cb ff ff       	call   801038f0 <mycpu>
80106ddb:	89 c7                	mov    %eax,%edi
80106ddd:	e8 0e cb ff ff       	call   801038f0 <mycpu>
80106de2:	83 c7 08             	add    $0x8,%edi
80106de5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106de8:	e8 03 cb ff ff       	call   801038f0 <mycpu>
...
80106ecb:	77 4b                	ja     80106f18 <inituvm+0x68>
  mem = kalloc();
80106ecd:	e8 ae b7 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106edf:	e8 dc da ff ff       	call   801049c0 <memset>
...
80106f12:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106f13:	e9 48 db ff ff       	jmp    80104a60 <memmove>
    panic("inituvm: more than a page");
80106f18:	83 ec 0c             	sub    $0xc,%esp
80106f1b:	68 95 7e 10 80       	push   $0x80107e95
80106f20:	e8 5b 94 ff ff       	call   80100380 <panic>
...
80106f80:	68 af 7e 10 80       	push   $0x80107eaf
80106f85:	e8 f6 93 ff ff       	call   80100380 <panic>
...
80106fce:	e8 bd aa ff ff       	call   80101a90 <readi>
...
80107008:	68 50 7f 10 80       	push   $0x80107f50
8010700d:	e8 6e 93 ff ff       	call   80100380 <panic>
...
8010706b:	e8 50 d9 ff ff       	call   801049c0 <memset>
...
80107099:	76 48                	jbe    801070e3 <allocuvm+0xc3>
    mem = kalloc();
8010709b:	e8 e0 b5 ff ff       	call   80102680 <kalloc>
...
801070a9:	68 cd 7e 10 80       	push   $0x80107ecd
801070ae:	e8 ed 95 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
8010710b:	68 e5 7e 10 80       	push   $0x80107ee5
80107110:	e8 8b 95 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80107130:	e8 8b b3 ff ff       	call   801024c0 <kfree>
      return 0;
...
801071ce:	e8 ed b2 ff ff       	call   801024c0 <kfree>
...
801071e3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
801071e4:	e9 d7 b2 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
801071e9:	83 ec 0c             	sub    $0xc,%esp
801071ec:	68 01 7f 10 80       	push   $0x80107f01
...
80107220:	e8 9b d7 ff ff       	call   801049c0 <memset>
...
8010728b:	a3 c4 44 11 80       	mov    %eax,0x801144c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801072bc:	68 12 7f 10 80       	push   $0x80107f12
...
80107332:	68 1c 7f 10 80       	push   $0x80107f1c
...
80107390:	e8 cb d6 ff ff       	call   80104a60 <memmove>
...
80107407:	68 36 7f 10 80       	push   $0x80107f36
...
801074c0:	e8 9b d5 ff ff       	call   80104a60 <memmove>
    len -= n;
    buf += n;
